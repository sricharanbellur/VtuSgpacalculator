...
public class Ise4semActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ise4sem);
        ...
        sgpares = findViewById(R.id.sgparesise4);
        calculate=findViewById(R.id.ise4calculate);
