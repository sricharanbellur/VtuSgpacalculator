...
public class Ise7semActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ise7sem);
        ...
        sgpares = findViewById(R.id.sgparesise7);
        calculate=findViewById(R.id.ise7calculate);
